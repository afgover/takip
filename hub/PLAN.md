...
> harcamasını kaydetmez — "geçmiş repoların toplam token kullanımı" doğrudan
> okunamaz. Okunabilenler: hub dosyalarının boyutu ve büyüme hızı (açılış
...
> `shell.dart` sekmeleri `_screens[_index]` ile taşıyor — sekme değişince
> ekran **yok ediliyor**, form durumu onunla gidiyor. İkinci katman: Android
> arka planda süreci öldürünce bellekteki her şey uçar; kalıcılık ancak
