...
**Bu belge sözleşme sürümü 1.16'ya göre yazıldı.** Sözleşmenin kendisi daha
...
4. **Geridesen:** ana kopyayı `SYSTEM.md` ve `AGENT_PROTOCOL.md` üzerine yaz,
   ...
   (`system: sözleşme 1.6 → 1.16 güncellendi`), `EVOLUTION.md`'ye tek satır not
...
Commit: `system: hub iskeleti kuruldu (sözleşme 1.16)`
...
değildir. Kullanıcı **aktif repodaki** işaretlerini uygulamada tek listede görüyor ve
oradan belgeye gidiyor (1.13).
...
system: sözleşme 1.6 → 1.16 güncellendi
```
