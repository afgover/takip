...
**Bu belge sözleşme sürümü 1.17'ye göre yazıldı.** Sözleşmenin kendisi daha
...
4. **Geridesen:** ana kopyayı `SYSTEM.md` ve `AGENT_PROTOCOL.md` üzerine yaz,
   ...
   (`system: sözleşme 1.6 → 1.17 güncellendi`), `EVOLUTION.md`'ye tek satır not
...
Commit: `system: hub iskeleti kuruldu (sözleşme 1.17)`
...
system: sözleşme 1.6 → 1.17 güncellendi
```
